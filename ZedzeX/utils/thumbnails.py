...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"ZedzeX/assets/zedzex.png")
        ...
        font = ImageFont.truetype("ZedzeX/assets/font2.ttf", 45)
        ImageFont.truetype("ZedzeX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("ZedzeX/assets/font2.ttf", 30)
        ImageFont.truetype("ZedzeX/assets/font.ttf", 30)
